...
public final class CollectionUtilPlus {
     ...
     */
    public static <T> boolean exists(Iterable<T> input, Predicate<? super T> predicate) {
        return org.apache.commons.collections4.CollectionUtils.exists(input, predicate);
    }
